...
import { Mail, Inbox, Send, Archive, Trash2, Folder, Loader2, ChevronRight, RefreshCw, Plus } from "lucide-react";
...
export const EmailInbox: React.FC = () => {
  ...
  const handleFolderSelect = async (folderId: string) => {
    ...
    try {
      const { messages } = await zohoService.getMessages(folderId);
