...
export default function EstimateDetail() {
	...
	return (
		<div className="p-6 space-y-6">
			...
			{/* Status Banner */}
			<div className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium ${getStatusConfig(estimate.status).className}`}>
				<Badge className={`${getStatusConfig(estimate.status).className} mr-1`}>
