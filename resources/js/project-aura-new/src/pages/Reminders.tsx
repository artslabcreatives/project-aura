        ...
        <div className="container mx-auto p-6 max-w-5xl space-y-8">
            ...
            {isHR ? (
                <Tabs defaultValue="personal" className="space-y-6">
                    <TabsList className="bg-muted/30 p-1 rounded-xl glass-morphism border border-white/10 shadow-lg">
                        <TabsTrigger value="personal" className="rounded-lg font-bold tracking-tight px-6 py-2.5 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground transition-all">
                            Personal Reminders
                        </TabsTrigger>
                        <TabsTrigger value="automated" className="rounded-lg font-bold tracking-tight px-6 py-2.5 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground transition-all">
                            Automated Reminder Management
                        </TabsTrigger>
                    </TabsList>
                    
                    <TabsContent value="personal" className="space-y-10 focus:outline-none">
                        {renderRemindersContent()}
                    </TabsContent>
                    
                    <TabsContent value="automated" className="focus:outline-none">
