import { c as constructNow, i as isPast, u as useNavigate, j as jsxRuntimeExports, C as CircleAlert, T as TrendingUp, a as CircleCheck, b as api, r as requireIsSymbol, d as require_baseGetTag, e as requireIsObject, f as require_root, g as require_Symbol, h as getDefaultExportFromCjs, k as requireIsObjectLike, l as reactExports, m as clsx, R as React, n as require_freeGlobal, t as throttle, o as requireToNumber, L as LoaderCircle, p as reactDomExports, X, B as Button, q as Check, s as ChevronRight, v as useUser, S as Skeleton, w as taskService, x as projectService, y as endOfMonth, z as cn, A as ScrollArea, D as userService, E as departmentService, F as useToast } from "./index-C4ZP3eFM.js";
...
import { i as isThisMonth, a as isSameWeek } from "./isThisMonth-C4UtR1WR.js";
...
import { T as TaskDetailsDialog, a as TaskCard } from "./TaskCard-DsczT6D6.js";
import { S as Sparkles } from "./sparkles-BJEvvLwV.js";
import { C as ChevronLeft } from "./chevron-left-zAeTltYW.js";
import { s as startOfWeek, f as format$1 } from "./format-BDODTvac.js";
...
function isTomorrow(date2) {
  return isSameDay(date2, addDays(constructNow(date2), 1));
}
function DashboardStats({ tasks, projects }) {
  ...
  const isTaskCompleted = (task) => {
    ...
    if (projects && projects.length > 0 && task.projectStage) {
      ...
      if (task.projectId) {
        ...
        if (project) {
          stage = project.stages.find((s2) => String(s2.id) === String(task.projectStage));
        }
      }
      if (!stage) {
        const project = projects.find((p) => p.stages.some((s2) => String(s2.id) === String(task.projectStage)));
        stage = project?.stages.find((s2) => String(s2.id) === String(task.projectStage));
      }
      if (stage) {
  ...
  const allTasks = allTasksRaw.filter((task) => {
    ...
    if (task.projectStage) {
      const project = projects.find((p) => String(p.id) === String(task.projectId));
      if (project) {
        const stage = project.stages.find((s2) => String(s2.id) === String(task.projectStage));
  ...
  const overdue = allTasks.filter(
    (task) => !isTaskCompleted(task) && task.dueDate && isPast(new Date(task.dueDate)) && !isToday(new Date(task.dueDate))
  ).length;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-4", children: stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card,
    {
...
function AdminAnalytics() {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-64 w-full items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-8 w-8 animate-spin text-primary" }) });
  }
  if (!data) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-muted-foreground", children: "Failed to load analytics data." });
  }
  ...
  const trendIcon = trend === "up" ? /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-4 w-4 text-green-500" }) : trend === "down" ? /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "h-4 w-4 text-red-500" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "-" });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold tracking-tight", children: "Analytics Overview" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Detailed insights into task completion and performance." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: period, onValueChange: (value) => setPeriod(value), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-[180px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select period" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "quarter", children: "This Quarter" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium", children: "Total Completed" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4 text-primary" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold", children: completion_analytics.total_completed }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground flex items-center gap-1 mt-1", children: [
            trendIcon,
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: trendColor, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium", children: "Completion Rate" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium", children: "Avg. Completion Time" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-4 w-4 text-orange-500" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-2xl font-bold", children: [
            completion_time.average_days,
            " days"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1", children: [
            "~ ",
            completion_time.average_hours,
            " hours"
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium", children: "Pending Tasks" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-4 w-4 text-red-500" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold", children: completion_rate.pending_tasks }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1", children: [
            "Tasks created in this ",
            period
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-7", children: [
      trendData.length > 0 && trendData.some((d) => d.tasks > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Completion Trend" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pl-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[300px] w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data: trendData, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "colorTasks", x1: "0", y1: "0", x2: "0", y2: "1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: "#8884d8", stopOpacity: 0.8 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "95%", stopColor: "#8884d8", stopOpacity: 0 })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "name", stroke: "#888888", fontSize: 12, tickLine: false, axisLine: false }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "#888888", fontSize: 12, tickLine: false, axisLine: false, tickFormatter: (value) => `${value}` }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey: "tasks", stroke: "#8884d8", fillOpacity: 1, fill: "url(#colorTasks)" })
        ] }) }) }) })
      ] }),
      projectData.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Top Projects" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[300px] w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: projectData, layout: "vertical", margin: { top: 5, right: 30, left: 20, bottom: 5 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { type: "number", hide: true }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { type: "category", dataKey: "project_name", width: 100, tick: { fontSize: 12 } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Tooltip,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", fill: "#adfa1d", radius: [0, 4, 4, 0], children: projectData.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: COLORS[index % COLORS.length] }, `cell-${index}`)) })
        ] }) }) }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-7", children: [
      userData.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Top Users" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[300px] w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: userData, layout: "vertical", margin: { top: 5, right: 30, left: 20, bottom: 5 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { type: "number", hide: true }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { type: "category", dataKey: "user_name", width: 100, tick: { fontSize: 12 } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Tooltip,
            {
              formatter: (value) => [value, "Completed Tasks"],
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", fill: "#8884d8", radius: [0, 4, 4, 0], children: userData.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: COLORS[index % COLORS.length] }, `cell-${index}`)) })
        ] }) }) }) })
      ] }),
      stageData.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Tasks by Stage" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[300px] w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: stageData, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "stage_name", fontSize: 12, tickLine: false, axisLine: false }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { fontSize: 12, tickLine: false, axisLine: false }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Tooltip,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", fill: "#82ca9d", radius: [4, 4, 0, 0] })
        ] }) }) }) })
      ] })
    ] }),
    !(trendData.length > 0 && trendData.some((d) => d.tasks > 0) || projectData.length > 0 || userData.length > 0 || stageData.length > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-[200px] w-full items-center justify-center text-muted-foreground flex-col gap-2 border rounded-lg border-dashed", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-8 w-8 opacity-20" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Data not available for this period" })
    ] })
  ] });
}
function OnboardingTour({ steps, isOpen, onComplete, onSkip, tourId }) {
  const [currentStep, setCurrentStep] = reactExports.useState(0);
  const [targetRect, setTargetRect] = reactExports.useState(null);
  const [tooltipPosition, setTooltipPosition] = reactExports.useState({ top: 0, left: 0 });
  ...
  return reactDomExports.createPortal(
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-[9999]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("mask", { id: "spotlight-mask", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold mb-2", children: step?.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-6 leading-relaxed", children: step?.content }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
...
function useOnboardingTour(tourId) {
  const [isOpen, setIsOpen] = reactExports.useState(false);
  const hasCompleted = reactExports.useCallback(() => {
    return localStorage.getItem(`onboarding_${tourId}_completed`) === "true";
  }, [tourId]);
  const startTour = reactExports.useCallback(() => {
    setIsOpen(true);
  }, []);
  const endTour = reactExports.useCallback(() => {
    setIsOpen(false);
  }, []);
  const resetTour = reactExports.useCallback(() => {
    localStorage.removeItem(`onboarding_${tourId}_completed`);
  }, [tourId]);
  const autoStart = reactExports.useCallback(() => {
    if (!hasCompleted()) {
      setTimeout(() => setIsOpen(true), 1e3);
    }
  }, [hasCompleted]);
  return {
    isOpen,
...
function AdminView() {
  ...
  reactExports.useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        const forbiddenStageIds = /* @__PURE__ */ new Set();
        projectsData.forEach((p) => {
          p.stages.forEach((s2) => {
            if (forbiddenStageTitles.includes(s2.title.toLowerCase().trim())) {
              forbiddenStageIds.add(s2.id);
            }
          });
        });
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative overflow-hidden rounded-2xl p-8 bg-background border shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-4", children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 rounded-xl border bg-card", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-tour": "dashboard-header", className: "relative overflow-hidden rounded-2xl p-8 bg-gradient-to-br from-primary via-primary-light to-accent shadow-xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-7 h-7 text-white", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold text-white tracking-tight", children: "Admin Dashboard" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/90 mt-1 text-lg", children: "Complete system overview and analytics" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-tour": "dashboard-stats", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardStats, { tasks, projects }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 mb-8", "data-tour": "admin-analytics", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AdminAnalytics, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      TaskDetailsDialog,
      {
        task: viewTask,
...
function TaskCalendar({ tasks, onViewTask, onTaskUpdate }) {
  ...
  const getTasksForDate = (date2) => {
    return tasks.filter(
      (task) => task.dueDate && isSameDay(new Date(task.dueDate), date2) && task.userStatus !== "complete"
    );
  };
  const selectedDateTasks = getTasksForDate(selectedDate);
  const overdueTasks = tasks.filter(
    (task) => task.dueDate && isPast(new Date(task.dueDate)) && !isToday(new Date(task.dueDate)) && task.userStatus !== "complete"
  );
  const weekTasks = tasks.filter(
    (task) => task.dueDate && isSameWeek(new Date(task.dueDate), /* @__PURE__ */ new Date()) && task.userStatus !== "complete"
  ).sort((a2, b) => new Date(a2.dueDate).getTime() - new Date(b.dueDate).getTime());
  let listTasks = selectedDateTasks;
  let listTitle = format$1(selectedDate, "EEEE, MMMM do");
  if (filter === "overdue") {
    ...
    listTitle = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: format$1(selectedDate, "EEEE, MMMM do") });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row gap-6 h-[750px] lg:h-[600px]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full lg:w-2/3 bg-card rounded-xl border shadow-sm flex flex-col h-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 border-b", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary/10 p-2 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-5 w-5 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-lg", children: format$1(currentMonth, "MMMM yyyy") })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 border-b bg-muted/40", children: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 text-center text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: day }, day)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 flex-1 auto-rows-fr bg-muted/20", children: calendarDays.map((day, dayIdx) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between items-start", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 flex-wrap content-end", children: dayTasks.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 w-full", children: [
                dayTasks.slice(0, 4).map((task, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: cn(
                ...
                dayTasks.length > 4 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-1.5 rounded-full bg-muted-foreground/50" })
              ] }) })
            ]
          },
          day.toString()
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full lg:w-1/3 flex flex-col gap-4 h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border shadow-sm flex-1 flex flex-col overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 border-b bg-muted/10 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg flex items-center gap-2", children: listTitle }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            ...
            onValueChange: (v) => {
              setFilter(v);
              if (v === "today") setSelectedDate(/* @__PURE__ */ new Date());
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-[130px] h-8 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Filter" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                ...
                filter === "custom" && /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "custom", disabled: true, className: "hidden", children: "Custom Date" })
              ] })
            ]
          }
        )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        filter !== "overdue" && overdueTasks.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-destructive font-semibold text-sm uppercase tracking-wide", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 pl-1", children: overdueTasks.map((task) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "scale-95 origin-left opacity-90 hover:opacity-100 hover:scale-100 transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            TaskCard,
            {
              task,
              onDragStart: () => {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b my-4 opacity-50" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium text-muted-foreground uppercase tracking-wide", children: filter === "overdue" ? "Overdue Items" : filter === "week" ? "Tasks for this week" : "Scheduled Tasks" }),
          listTasks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-10 text-center text-muted-foreground border-2 border-dashed rounded-lg bg-muted/20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-10 w-10 mb-2 opacity-20" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: filter === "overdue" ? "No overdue tasks" : filter === "week" ? "No tasks this week" : "No tasks scheduled for this day" })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: listTasks.map((task) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            TaskCard,
            {
              task,
              onDragStart: () => {
...
function TeamLeadView() {
  ...
  const departmentTasks = reactExports.useMemo(() => {
    ...
    return tasks.filter((task) => {
      ...
      if (isAssignedToDepartment || isProjectInDepartment) {
        const forbiddenStageTitles = ["suggested", "suggested task"];
        const stage = taskProject?.stages.find((s2) => s2.id === task.projectStage);
  ...
  const calendarTasks = reactExports.useMemo(() => {
    const flattenTasks = (taskList) => {
      const flattened = [];
      const seenIds = /* @__PURE__ */ new Set();
      const recurse = (items) => {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-1 bg-primary rounded-full" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-6 w-48" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border p-4 space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 gap-4", children: [...Array(35)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-24 w-full rounded-md" }, i)) })
        ] })
      ] })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-tour": "dashboard-header", className: "relative overflow-hidden rounded-2xl p-8 bg-gradient-to-br from-secondary via-secondary-light to-primary shadow-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold text-white tracking-tight", children: "Team Lead Dashboard" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/90 mt-1 text-lg", children: [
              getDepartmentName(),
              " department overview and progress"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-tour": "dashboard-stats", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardStats, { tasks: departmentTasks, projects }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-tour": "team-calender", className: "mt-8 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-1 bg-primary rounded-full" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-foreground/80", children: "Team Calendar" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TaskCalendar,
        {
...
function UserView() {
  const { currentUser } = useUser();
  const [statsTasks, setStatsTasks] = reactExports.useState([]);
  const [tasks, setTasks] = reactExports.useState([]);
  const [projects, setProjects] = reactExports.useState([]);
  const [viewTask, setViewTask] = reactExports.useState(null);
  const [isViewDialogOpen, setIsViewDialogOpen] = reactExports.useState(false);
      ...
      if (currentUser) {
        ...
        try {
          ...
          const archivedProjectIds = new Set(
            projectsData.filter((p) => p.isArchived).map((p) => p.id)
          );
          const allAssignedTasks = allFlatTasks.filter((task) => {
          ...
          const activeTasks = allAssignedTasks.filter((task) => {
            if (task.projectStage && forbiddenStageIds.has(task.projectStage)) return false;
            if (task.userStatus === "complete") return false;
            return true;
          });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-tour": "dashboard-header", className: "relative overflow-hidden rounded-2xl p-8 bg-gradient-to-br from-accent via-accent-light to-primary shadow-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold text-white tracking-tight", children: "My Dashboard" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/90 mt-1 text-lg", children: [
              "Welcome back, ",
              currentUser?.name,
              "! 👋"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-tour": "dashboard-stats", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardStats, { tasks: statsTasks, projects }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-tour": "task-calendar", className: "mt-8 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-1 bg-primary rounded-full" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-foreground/80", children: "Task Calendar" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TaskCalendar,
        {
...
function AccountManagerView() {
  ...
  const handleCreateTask = async (taskData, pendingFiles, pendingLinks) => {
    try {
  ...
  const overdueTasks = departmentTasks.filter(
    (task) => !task.parentId && !isTaskCompleted(task) && task.dueDate && isPast(new Date(task.dueDate)) && !isToday(new Date(task.dueDate))
  );
  ...
  const thisMonthTasks = departmentTasks.filter((task) => {
    if (!task.dueDate) return false;
    const dueDate = new Date(task.dueDate);
    return !task.parentId && !isTaskCompleted(task) && isSameMonth(dueDate, today) && !isPast(dueDate);
  });
  const getDepartmentName = () => {
    if (currentUser && departments.length > 0) {
      const dept = departments.find((d) => d.id === currentUser.department);
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:grid-cols-2 lg:grid-cols-4", children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "overflow-hidden", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-tour": "dashboard-header", className: "relative overflow-hidden rounded-2xl p-8 bg-gradient-to-br from-secondary via-secondary-light to-primary shadow-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-7 h-7 text-white", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold text-white tracking-tight", children: "Account Manager Dashboard" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/90 mt-1 text-lg", children: [
              getDepartmentName(),
              " department overview and progress"
            ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-tour": "dashboard-stats", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardStats, { tasks: departmentTasks, projects }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-tour": "am-tasks-overview", className: "grid gap-6 md:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "hover-lift border-2 border-primary/20 bg-gradient-to-br from-card to-primary/5 overflow-hidden group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-32 h-32 bg-primary/10 rounded-full blur-3xl group-hover:bg-primary/20 transition-all duration-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 w-3 rounded-full bg-primary animate-pulse shadow-lg shadow-primary/50" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Due Today" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-xs bg-primary/10 text-primary px-2 py-1 rounded-full font-medium", children: dueTodayTasks.length })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-3 relative", children: dueTodayTasks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-8 h-8 text-primary", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-medium", children: "All clear for today!" })
        ] }) : dueTodayTasks.slice(0, 3).map((task, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "slide-in", style: { animationDelay: `${index * 0.1}s` }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          TaskCard,
          {
            task,
            onDragStart: () => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "hover-lift border-2 border-info/20 bg-gradient-to-br from-card to-info/5 overflow-hidden group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-32 h-32 bg-info/10 rounded-full blur-3xl group-hover:bg-info/20 transition-all duration-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 w-3 rounded-full bg-info animate-pulse shadow-lg shadow-info/50" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Tomorrow" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-xs bg-info/10 text-info px-2 py-1 rounded-full font-medium", children: tomorrowTasks.length })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-3 relative", children: tomorrowTasks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-16 h-16 rounded-full bg-info/10 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-8 h-8 text-info", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-medium", children: "No tasks for tomorrow" })
        ] }) : tomorrowTasks.slice(0, 3).map((task, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "slide-in", style: { animationDelay: `${index * 0.1}s` }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          TaskCard,
          {
            task,
            onDragStart: () => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "hover-lift border-2 border-success/20 bg-gradient-to-br from-card to-success/5 overflow-hidden group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-32 h-32 bg-success/10 rounded-full blur-3xl group-hover:bg-success/20 transition-all duration-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 w-3 rounded-full bg-success animate-pulse shadow-lg shadow-success/50" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "This Month" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-xs bg-success/10 text-success px-2 py-1 rounded-full font-medium", children: thisMonthTasks.length })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-3 relative", children: thisMonthTasks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-16 h-16 rounded-full bg-success/10 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-8 h-8 text-success", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-medium", children: "No tasks this month" })
        ] }) : thisMonthTasks.slice(0, 3).map((task, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "slide-in", style: { animationDelay: `${index * 0.1}s` }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          TaskCard,
          {
            task,
            onDragStart: () => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "hover-lift border-2 border-destructive/20 bg-gradient-to-br from-card to-destructive/5 overflow-hidden group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-32 h-32 bg-destructive/10 rounded-full blur-3xl group-hover:bg-destructive/20 transition-all duration-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 w-3 rounded-full bg-status-overdue animate-pulse shadow-lg shadow-destructive/50" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Overdue" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-xs bg-destructive/10 text-destructive px-2 py-1 rounded-full font-medium", children: overdueTasks.length })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-3 relative", children: overdueTasks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-16 h-16 rounded-full bg-secondary/10 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-8 h-8 text-secondary", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-medium", children: "No overdue tasks" })
        ] }) : overdueTasks.slice(0, 3).map((task, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "slide-in", style: { animationDelay: `${index * 0.1}s` }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          TaskCard,
          {
            task,
            onDragStart: () => {
...
function UserDashboard() {
  ...
  switch (role) {
    ...
    case "team-lead":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(TeamLeadView, {});
    case "account-manager":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(AccountManagerView, {});
    case "user":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(UserView, {});
    default:
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 fade-in p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 w-12 rounded-xl" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-64" }),
